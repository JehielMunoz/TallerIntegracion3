          ...
          @if (Auth::user()->rol == '1')
            ...
            <div class="card card-block">
              <a href="{{url('/inventario')}}">
                <img src="{{ asset('images/rrhh.png') }}" width="200" height="200" class="img-fluid rounded-circle" alt="Matriculas">
              </a>
            ...
            <div class="card card-block">
              <a href="{{url('/notas')}}">
                <img src="{{ asset('images/notas.png') }}" width="200" height="200" class="img-fluid rounded-circle" alt="Matriculas">
              </a>
              <h4>Notas</h4>
